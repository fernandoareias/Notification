...
public class RetrySendNotificationWhatsAppCommandHandler : IRequestHandler<RetrySendNotificationWhatsAppCommand, View>
{
    ...
    public async Task<View> Handle(RetrySendNotificationWhatsAppCommand request, CancellationToken cancellationToken)
    {
