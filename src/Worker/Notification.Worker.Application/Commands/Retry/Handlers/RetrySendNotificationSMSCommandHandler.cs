...
public class RetrySendNotificationSMSCommandHandler : IRequestHandler<RetrySendNotificationSMSCommand, View>
{
    ...
    public async Task<View> Handle(RetrySendNotificationSMSCommand request, CancellationToken cancellationToken)
    {
