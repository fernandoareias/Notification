...
public class SendNotificationSMSCommandHandler : IRequestHandler<SendNotificationSMSCommand, View>
{
    ...
    public async Task<View> Handle(SendNotificationSMSCommand request, CancellationToken cancellationToken)
    {
        bool create = false;
