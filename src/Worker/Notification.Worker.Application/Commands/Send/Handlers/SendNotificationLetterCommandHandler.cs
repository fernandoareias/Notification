...
public class SendNotificationLetterCommandHandler : IRequestHandler<SendNotificationLetterCommand, View>
{
    ...
    public async Task<View> Handle(SendNotificationLetterCommand request, CancellationToken cancellationToken)
    {
        bool create = false;
