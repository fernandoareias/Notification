...
public class RetrySendNotificationLetterCommandHandler : IRequestHandler<RetrySendNotificationLetterCommand, View>
{
    ...
    public async Task<View> Handle(RetrySendNotificationLetterCommand request, CancellationToken cancellationToken)
    {
