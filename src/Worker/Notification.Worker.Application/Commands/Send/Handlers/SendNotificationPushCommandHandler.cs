...
public class SendNotificationPushCommandHandler : IRequestHandler<SendNotificationPushCommand, View>
{
    ...
    public async Task<View> Handle(SendNotificationPushCommand request, CancellationToken cancellationToken)
    {
        bool create = false;
